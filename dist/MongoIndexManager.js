...
var _IndexManager2 = require('marsdb/dist/IndexManager');
...
var MongoIndexManager = (function (_IndexManager) {
  ...
  function MongoIndexManager() {
    _classCallCheck(this, MongoIndexManager);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(MongoIndexManager).apply(this, arguments));
  }
